...
% Lowest common ancestor precision (P_LCA), Recall(R_LCA), and F1(F_LCA)最近共同祖先精度
% measures.
% These measures use the concept of the lowest comm ancestor(LCA) as 这些度量使用最近共同祖先（LCA）的概念作为
